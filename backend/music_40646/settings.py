"""
Django settings for music_40646 project.
...
WSGI_APPLICATION = 'music_40646.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "music_40646 API",
    "DESCRIPTION": "API documentation for music_40646 App",
    "VERSION": "v1",
}
